...
void loop() {
  ...
  if (ps2x.Button(PSB_PAD_LEFT)) {
    ...
    MyMotor5.Start(-1, 5000 ); // 정방향 두바퀴
    MyMotor6.Start(1, 5000 ); // 정방향 두바퀴
    MyMotor7.Start(-1, 5000 ); // 정방향 두바퀴
    MyMotor8.Start(1, 5000 ); // 정방향 두바퀴
  ...
  if (ps2x.Button(PSB_PAD_DOWN)) {
    ...
    MyMotor5.Start(-1, 0 ); // 정방향 두바퀴
    MyMotor6.Start(1, 0 ); // 정방향 두바퀴
    MyMotor7.Start(-1, 0 ); // 정방향 두바퀴
    MyMotor8.Start(1, 0 ); // 정방향 두바퀴
  ...
  { int varValue = map(analogRead(VAR), 0, 1023, 0, 179);
    ...
    MyMotor5.Stop(); // 정방향 두바퀴
    MyMotor6.Stop(); // 정방향 두바퀴
    MyMotor7.Stop(); // 정방향 두바퀴
    MyMotor8.Stop(); // 정방향 두바퀴
