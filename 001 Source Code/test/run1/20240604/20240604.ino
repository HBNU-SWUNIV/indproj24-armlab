...
void loop() {
  ...
  { FlexiTimer2::set( 1, 0.09 / 1000, onTimer ); // 16 micro seconds.
    FlexiTimer2::start();
    MyMotor1.Start(-1, 1000 ); // 올라가는방향 두바퀴
    MyMotor2.Start(1, 1000 ); // 내려가는방향 두바퀴
    MyMotor3.Start(-1, 1000 ); // 올라가는방향 두바퀴
    MyMotor4.Start(1, 1000 ); // 내려가는방향 두바퀴

  } else if (alpha < -0.1)
  {
    FlexiTimer2::set( 1, 0.09 / 1000, onTimer ); // 16 micro seconds.
    FlexiTimer2::start();
    MyMotor1.Start(1, 1000 ); // 내려가는방향 두바퀴
    MyMotor2.Start(-1, 1000 ); // 올라가는방향 두바퀴
    MyMotor3.Start(1, 1000 ); // 내려가는방향 두바퀴
    MyMotor4.Start(-1, 1000 ); // 올라가는방향 두바퀴
  }
